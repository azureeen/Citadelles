    ...
    public void utiliserPouvoir() {
            ...
            do{
                ...
                for(int i=0; i<joueurDiplo.nbQuartiersDansCite(); i++){
                    System.out.println((i+1)+". Nom: "+joueurDiplo.getCite()[i].getNom()+", coût: "+joueurDiplo.getCite()[i].getCoutConstruction()+", type: "+joueurDiplo.getCite()[i].getType()+".");
                }
                        ...
                        if(choix != -1){
                            ...
                            if(joueurChoisi.getPersonnage().getRang() == 8){      //si se choisit soit même
                                ...
                                if(!quartierDiplo.getNom().equals(quartierAdv.getNom()) && presentChezAdv){
                                    ...
                                    if (this.getJoueur().nbPieces() > (quartierAdv.getCoutConstruction() - quartierDiplo.getCoutConstruction() + 1) && aGrandeMuraille){
                                        System.out.println("Vous avez choisi d'échanger avec la Merveille Grande Muraille. Vous payez donc 1 piece de plus");
                                        joueurDiplo.retirerPieces(quartierAdv.getCoutConstruction() - quartierDiplo.getCoutConstruction() + 1);
                                    ...
                                    else if(this.getJoueur().nbPieces() > (quartierAdv.getCoutConstruction() - quartierDiplo.getCoutConstruction())){
                                        continu2 = false;
                                        continu1=false;
                                        System.out.println("Vous avez échangé "+quartierDiplo.getNom()+" avec "+quartierAdv.getNom());

                                        joueurDiplo.retirerPieces(quartierAdv.getCoutConstruction() - quartierDiplo.getCoutConstruction());
                ...
                if(oui && !(this.getJoueur().nbQuartiersDansCite()==0)){
                    ...
                    do {
                        ...
                        if(choix != -1){
                            ...
                            }else if(joueurChoisi.toString().equals("Eveque")){
                                System.out.println("Vous ne pouvez pas utiliser votre pourvoir sur l'eveque");
                            }
                            else{      // si choisit qqn d'autre
