...
public class Caracteristiques {
	...
	public static String ECHEVIN= 
		...
		"le joueur ciblé, qui récupéré le coût de construction.";
	...
	public static String ESPION=
		...
		"indiqué, il reçoit 1 piéce d'or de ce joueur et pioche 1 " +
		"carte Quartier.";
	...
	public static String SORCIER=
		...
		"et peut soit payer son coét pour la bâtir, soit l'ajouter " +
	...
	public static String ABBE=
		"Le joueur le plus riche doit donner 1 piéce d'or à l'Abbé." +
	...
	public static String EVEQUE=
		"La cité de l'Évéque est protégée contre les personnages " +
	...
	public static String MARCHANDE=
		"La Marchande reçoit 1 piéce d'or supplémentaire. Chaque " +
		"quartier Commerçant dans sa cité lui rapporte 1 piéce d'or.";
	...
	public static String ARTISTE=
		...
		"leur assignant 1 piéce d'or. Un méme quartier ne peut être " +
